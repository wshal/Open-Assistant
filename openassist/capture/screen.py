...
class ScreenCapture(QObject):
    ...
    def __init__(self, config, ocr: OCREngine):
        ...
        self._max_w = config.get("capture.screen.downscale_width", 1920)
    ...
    def capture(self) -> Optional[str]:
        ...
        try:
            ...
            # phase 2: Extraction
            text, boxes = self.ocr.extract(target_img)
    ...
    def _update_crop_box(self, boxes, offset_x, offset_y, screen_size):
        ...
        abs_boxes = [(b[0]+offset_x, b[1]+offset_y, b[2]+offset_x, b[3]+offset_y) for b in boxes]
    ...
    def _has_changed(self, new_text: str) -> bool:
        ...
        if not self._last_text: return True
