...
const { setupGeminiIpcHandlers, stopMacOSAudioCapture, sendToRenderer, clearCache, deleteCachedResponse, getCacheStats } = require('./utils/gemini');
...
function setupStorageIpcHandlers() {
    ...
    ipcMain.handle('cache:delete-entry', async (event, question) => {
        try {
            const deleted = deleteCachedResponse(question);
